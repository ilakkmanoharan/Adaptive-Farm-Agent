...
def _agent_impl(obs, config=None):
    ...
    if _money >= 120 and _owned_land >= 2 and _wheat_seeds >= 4:
        _last_action = "BUY"
        return {"action": "BUY", "item": "land", "n": 1}

    if _money >= 25 and _wheat_seeds < 6 and _owned_land > 0 and day < 20 and not weeds:
    ...
    if _money >= 25 and _wheat_seeds < 5 and day < 20:
        _last_action = "BUY"
